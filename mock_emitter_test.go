...
// Package cff is a generated GoMock package.
package cff
...
func (m *MockEmitter) FlowInit(arg0 *FlowInfo) FlowEmitter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FlowInit", arg0)
	ret0, _ := ret[0].(FlowEmitter)
	return ret0
}
...
func (m *MockEmitter) ParallelInit(arg0 *ParallelInfo) ParallelEmitter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParallelInit", arg0)
	ret0, _ := ret[0].(ParallelEmitter)
	return ret0
}
...
func (m *MockEmitter) SchedulerInit(arg0 *SchedulerInfo) SchedulerEmitter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SchedulerInit", arg0)
	ret0, _ := ret[0].(SchedulerEmitter)
	return ret0
}
...
func (m *MockEmitter) TaskInit(arg0 *TaskInfo, arg1 *DirectiveInfo) TaskEmitter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TaskInit", arg0, arg1)
	ret0, _ := ret[0].(TaskEmitter)
	return ret0
}
